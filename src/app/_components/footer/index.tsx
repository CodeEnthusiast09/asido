...
const Footer = () => {
  ...
  return (
    <footer className="bg-primary-100 text-white px-9 py-[60px] lg:px-10 lg:pt-10 lg:pb-7 xl:px-20 xl:pt-22 xl:pb-14 relative">
      <div className="lg:max-w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          <div className="flex flex-col items-center lg:items-start">
            ...
            <p className="text-xs lg:text-base lg:font-medium text-center lg:text-left lg:max-w-80 leading-tight lg:mb-10 xl:mb-[89.68px]">
              Making mental health support accessible through advocacy and
              action
            </p>
            {/* Social media links */}
            <div className="hidden lg:flex gap-4 xl:mb-[55px]">
              <a
                href="#twitter"
          ...
          {/* Navigation sections */}
          <div className="grid grid-cols-2 lg:col-span-2 lg:flex justify-between xl:gap-[120px] z-50">
            {Object.entries(navLinks).map(([title, links]) => (
              <div key={title} className="mb-10 text-sm">
                <hr className="w-[135px] mb-5 bg-secondary-400 lg:hidden" />

                <h3 className="lg:text-xl font-bold mb-4">{title}</h3>

                <ul className="space-y-2 font-medium lg:text-base">
                  {links.map((link) => (
                    <li key={link}>
            ...
            <div className="col-span-2 pt-5 border-t border-secondary-400 text-sm lg:border-t-0 lg:pt-0">
              <h3 className="font-bold mb-4 text-center lg:text-xl lg:text-left">
                Contact Us
              </h3>
                ...
                {contactInfo.map((item, index) => {
                  ...
                  return (
                    <li key={index} className="flex gap-[9.5px] items-start">
                      ...
                      <div className="lg:text-base font-medium">
                        {Array.isArray(item.content) ? (
                          <div className="flex flex-row lg:flex-col gap-[12px] ">
        ...
        <div className="pt-5 border-t border-secondary-400 flex  flex-col items-center lg:block">
          <p className="text-xs lg:text-base font-medium mb-5 lg:mb-0">
